...
namespace Carbonfrost.Commons.Validation {
	...
	[AttributeUsage(AbstractValidatorAttribute.COMMON_TARGETS, AllowMultiple = false, Inherited = false)]
	public sealed class FutureAttribute : AbstractValidatorAttribute {
